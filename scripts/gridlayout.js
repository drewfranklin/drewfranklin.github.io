...
GridLayout.prototype.applyCSS = function ()
{
	...
	if(gridLayoutObj.grid_settings.percent == true)
	{
		...
		$('#GridLayout li').css({'background-image':'url(http://gridlayouts.com/_assets/_graphics/gridlayout.png)','background-repeat':'repeat', display:'block','float':'left',position:'relative'});
